        ...
        <div className="bg-white dark:bg-black/80 p-4 rounded-lg shadow-lg border border-slate-200 dark:border-blue-500/30">
          ...
          <div className="space-y-1 text-sm">
            <p className="flex items-center gap-2">
              ...
              <span className="text-black dark:text-white">Przepływ:</span>
              <span className={`font-bold ${data.cashFlow >= 0 ? 'text-black dark:text-white' : 'text-black dark:text-white'}`}>
                {formatCurrency(data.cashFlow)}
              </span>
            </p>
            <p className="flex items-center gap-2">
              <span className="w-3 h-3 rounded-full bg-purple-500"></span>
              <span className="text-black dark:text-white">Skumulowany:</span>
              <span className={`font-bold ${data.cumulative >= 0 ? 'text-black dark:text-white' : 'text-black dark:text-white'}`}>
