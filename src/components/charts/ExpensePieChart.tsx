        ...
        <div className="bg-white dark:bg-black/80 p-4 rounded-lg shadow-lg border border-slate-200 dark:border-blue-500/30">
          ...
          <div className="space-y-1 text-sm">
            <p className="text-black dark:text-white">
              Kwota: <span className="font-bold text-black dark:text-white">{formatCurrency(data.value)}</span>
            </p>
            <p className="text-black dark:text-white">
              Udział: <span className="font-bold text-black dark:text-white">{data.payload.percentage.toFixed(1)}%</span>
            </p>
          </div>
        </div>
      );
